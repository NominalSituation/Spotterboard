      ...
      <div className="max-w-6xl mx-auto">
        ...
        {session ? (
          <div className="bg-white border-2 border-[#80deea] rounded-2xl p-4 shadow-md">
            ...
            {/* MAIN AREA: feed (left) + leaderboard (right) */}
            <div className="layout-two-col mt-4">
              {/* LEFT: feed */}
              <div>
                {activeTab === "all" && (
              ...
              {/* RIGHT: leaderboard */}
              <aside className="leaderboard-card" aria-label="Top Spotter">
